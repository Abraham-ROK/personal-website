...
export const experienceData = {
  experience: [
...

    {
      ...
      title: "Data Science",
      skills: [
        { id: "3-1", icon: checkmarkLight, iconDark: checkmarkDark,  name: "PostgreSQL", level: "Basic" },
        { id: "3-2", icon: checkmarkLight, iconDark: checkmarkDark,  name: "Node JS", level: "Intermediate" },
        { id: "3-3", icon: checkmarkLight, iconDark: checkmarkDark,  name: "Express JS", level: "Intermediate" },
        { id: "3-4", icon: checkmarkLight, iconDark: checkmarkDark,  name: "Git", level: "Intermediate" }
      ]
    }
  ]
};
